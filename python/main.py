...
from SVC import create_and_fit_SVC_classifier, get_default_config, get_train_test_validation_split, sample_flattened_dataset, average_sampling
...
def main(use_existing_model=True):
    ...
    X_train, X_test, Y_train, Y_test = get_train_test_validation_split(df_avg_data)
