...
from SVC import create_and_fit_SVC_classifier, get_default_config, get_train_test_split, flattened_dataframe_square_sum
...
def main():
    ...
    square_data =  flattened_dataframe_square_sum(df)
    X_train, X_test, Y_train, Y_test = get_train_test_split(square_data)
